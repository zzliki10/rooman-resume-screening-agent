...
Features:
- Upload Job Description (text/PDF)
- Upload multiple Resume PDFs
- AI ranks candidates with score (0–100)
- Shows explanation, missing skills & keyword suggestions

Tech Stack:
- Streamlit + OpenAI GPT-4o-mini + LangChain + PyPDF
